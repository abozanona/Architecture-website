<div class="wrap">
	...
	update_option( 'notificationActive', 'no' );
	?>
	<div class="ufbl-entry-filter-wrap">
		<h3><?php _e( 'إدخالات المستخدمين', 'ultimate-form-builder-lite' ); ?></h3>
		...
		<thead>
			<tr>
				...
				<th scope="col" id="shortcode" class="manage-column column-shortcode">
					<?php _e( 'تاريخ الاستقبال', 'ultimate-form-builder-lite' ); ?>
				</th>
					...
					<tr class="<?php if ( $form_counter % 2 != 0 ) { ?>alternate<?php } ?>">
						<td class="title column-title">
							...
							<div class="row-actions ufbl-relative">
								...
								<span class="ufbl-view-entry"><a href="javascript:void(0);" data-entry-id="<?php echo $form_entry_row['entry_id']; ?>"><?php _e( 'عرض المدخلات', 'ultimate-form-builder-lite' ); ?></a></span>
								<div class="ufbl-delete-confirmation" style="display:none">
									<p><?php _e( 'هل أنت متأكد من أنك تريد حذف هذا الإدخال؟', 'ultimate-form-builder-lite' ); ?></p>
									<input type="button" value="<?php _e( 'نعم', 'ultimate-form-builder-lite' ); ?>"  data-entry-id="<?php echo $form_entry_row['entry_id']; ?>" class="ufbl-delete-yes ufbl-delete-entry-yes"/>
									<input type="button" value="<?php _e( 'إلغاء الأمر', 'ultimate-form-builder-lite' ); ?>" class="ufbl-delete-cancel"/>
