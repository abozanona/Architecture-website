	...
	<div class="ufbl-form-element-outerwrap">
		<div class="ufbl-form-elements-wrap">
			<div class="ufbl-form-elements-inner-wrap ufbl-relative">
				<span class="ufbl-form-element-title">عناصر النموذج</span>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'صندوق إدخال - سطر واحد' ?>" data-field-type="textfield"><br/>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'صندوق إدخال - أكثر من سطر' ?>" data-field-type="textarea"><br/>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'بريد إلكتروني' ?>" data-field-type="email"><br/>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'قائمة منسدلة'  ?>" data-field-type="dropdown"><br/>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'صندوق إدخال منفرد' ?>" data-field-type="radio"><br/>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'صندوق إدخال متعدد' ?>" data-field-type="checkbox"><br/>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'كلمة مرور' ?>" data-field-type="password"><br/>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'حقل مخفي' ?>" data-field-type="hidden"><br/>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'صندوق إدخال أرقام' ?>" data-field-type="number"><br/>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'صندوق إرسال المعلومات' ; ?>" data-field-type="submit"><br/>
				<input type="button" class="button-primary ufbl-form-element" value="<?= 'صندوق التحقق' ?>" data-field-type="captcha">
...
//						$library_obj->print_array($val);
						switch ( $val['field_type'] ) {
							case 'textfield':
								...
								<div class="ufbl-each-form-field ufbl-relative">
									...
									<div class="ufbl-form-field-wrap">
										<label class="ufbl-field-label-ref"><?php echo (isset( $val['field_label'] ) && $val['field_label'] != '') ? esc_attr( $val['field_label'] ) : 'صندوق إدخال بدون عنوان'; ?></label>
										<div class="ufbl-form-field">
											<input type="text" disabled="disabled"/>
										</div>
									</div><!--ufbl-form-field-wrap-->
									<div class="ufbl-field-controls">
										<a href="javascript:void(0)" class="ufbl-field-settings-trigger button-primary"><?= _e( 'الإعدادات', 'ultimate-form-builder-lite' ); ?></a><span>+</span>
										<a href="javascript:void(0)" class="ufbl-field-delete-trigger">حذف</a>
									</div>
									<div class="ufbl-field-settings-wrap" style="display:none;">
										<span class="ufbl-up-arrow"></span>
										<div class="ufbl-form-field-wrap">
											<label><?php _e( 'عنوان الصندوق', 'ultimate-form-builder-lite' ); ?></label>
											<div class="ufbl-form-field">
										...
										<div class="ufbl-form-field-wrap">
											<label><?php _e( 'إجباري', 'ultimate-form-builder-lite' ); ?></label>
											<div class="ufbl-form-field">
										...
										<div class="ufbl-form-field-wrap">
											<label><?php _e( 'أكبر عدد من الحروف', 'ultimate-form-builder-lite' ); ?></label>
											<div class="ufbl-form-field">
										...
										<div class="ufbl-form-field-wrap">
											<label><?php _e( 'أقل عدد من الحروف', 'ultimate-form-builder-lite' ); ?></label>
											<div class="ufbl-form-field">
										...
										<div class="ufbl-form-field-wrap">
											<label><?php _e( 'رسالة الخطأ', 'ultimate-form-builder-lite' ); ?></label>
											<div class="ufbl-form-field">
										...
										<div class="ufbl-form-field-wrap">
											<label><?php _e( 'النص البديل', 'ultimate-form-builder-lite' ); ?></label>
											<div class="ufbl-form-field">
										...
										<div class="ufbl-form-field-wrap">
											<label><?php _e( 'المحتوى الإبتدائي', 'ultimate-form-builder-lite' ); ?></label>
											<div class="ufbl-form-field">
							...
							case 'textarea':
								...
								<div class="ufbl-each-form-field ufbl-relative">
									...
									<div class="ufbl-field-settings-wrap" style="display:none;">
										...
										<div class="ufbl-form-field-wrap">
											<label><?php _e( 'طول الصندوق', 'ultimate-form-builder-lite' ); ?></label>
											<div class="ufbl-form-field">
										...
										<div class="ufbl-form-field-wrap">
											<label><?php _e( 'عرض الصندوق', 'ultimate-form-builder-lite' ); ?></label>
											<div class="ufbl-form-field">
							...
							case 'email':
								...
								<div class="ufbl-each-form-field ufbl-relative">
									<span class="ufbl-drag-arrow"><i class="fa fa-arrows"></i></span>
									<div class="ufbl-form-field-wrap">
										<label class="ufbl-field-label-ref"><?php echo (isset( $val['field_label'] ) && $val['field_label'] != '') ? esc_attr( $val['field_label'] ) : 'بريد إلكتروني بدون عنوان'; ?></label>
										<div class="ufbl-form-field">
							...
							case 'dropdown':
								...
								<div class="ufbl-each-form-field ufbl-relative">
									<span class="ufbl-drag-arrow"><i class="fa fa-arrows"></i></span>
									<div class="ufbl-form-field-wrap">
										<label class="ufbl-field-label-ref"><?php echo (isset( $val['field_label'] ) && $val['field_label'] != '') ? esc_attr( $val['field_label'] ) : 'قائمة منسدلة بدون عنوان'; ?></label>
										<div class="ufbl-form-field">
									...
									<div class="ufbl-field-settings-wrap" style="display:none;">
										...
										<div class="ufbl-form-field-wrap ufbl-full-width ufbl-op-wrap">
											<label><?php _e( 'الخيارات', 'ultimate-form-builder-lite' ); ?></label>
											<div class="ufbl-form-field">
												<input type="button" value="<?php _e( 'إضافة خيار', 'ultimate-form-builder-lite' ); ?>" class="ufbl-option-value-adder button-primary" data-field-key="<?php echo $key; ?>"/>
										...
										<div class="ufbl-form-field-wrap">
											<label><?php _e( 'اختيار متعدد', 'ultimate-form-builder-lite' ); ?></label>
							...
							case 'radio':
								...
								<div class="ufbl-each-form-field ufbl-relative">
									<span class="ufbl-drag-arrow"><i class="fa fa-arrows"></i></span>
									<div class="ufbl-form-field-wrap">
										<label class="ufbl-field-label-ref"><?php echo (isset( $val['field_label'] ) && $val['field_label'] != '') ? esc_attr( $val['field_label'] ) : 'صندوق اختيار بدون عنوان'; ?></label>
										<div class="ufbl-form-field">
							...
							case 'password':
								...
								<div class="ufbl-each-form-field ufbl-relative">
									<span class="ufbl-drag-arrow"><i class="fa fa-arrows"></i></span>
									<div class="ufbl-form-field-wrap">
										<label class="ufbl-field-label-ref"><?php echo (isset( $val['field_label'] ) && $val['field_label'] != '') ? esc_attr( $val['field_label'] ) : 'كلمة مرور بدون عنوان'; ?></label>
										<div class="ufbl-form-field">
							...
							case 'hidden':
								...
								<div class="ufbl-each-form-field ufbl-submit-button-wrap ufbl-relative">
									<span class="ufbl-drag-arrow"><i class="fa fa-arrows"></i></span>
									<div class="ufbl-form-field-wrap">
										<label class="ufbl-field-label-ref"><?php echo (isset( $val['field_label'] ) && $val['field_label'] != '') ? esc_attr( $val['field_label'] ) : 'حقل مخفي بدون عنوان'; ?></label>
										<div class="ufbl-form-field">
							...
							case 'number':
								...
								<div class="ufbl-each-form-field ufbl-relative">
									<span class="ufbl-drag-arrow"><i class="fa fa-arrows"></i></span>
									<div class="ufbl-form-field-wrap">
										<label class="ufbl-field-label-ref"><?php echo (isset( $val['field_label'] ) && $val['field_label'] != '') ? esc_attr( $val['field_label'] ) : 'رقم بدون عنوان'; ?></label>
										<div class="ufbl-form-field">
							...
							case 'submit':
								...
								<div class="ufbl-each-form-field ufbl-submit-button-wrap ufbl-relative">
									...
									<div class="ufbl-form-field-wrap">
										<div class="ufbl-form-field">
											<input type="submit" disabled="disabled" class="button-primary ufbl-submit-reference" value="<?php echo ($val['button_label'] == '') ? 'إرسال المعلومات' : esc_attr( $val['button_label'] ); ?>"/>
										</div>
									</div><!--ufbl-form-field-wrap-->
									<div class="ufbl-field-controls">
										<a href="javascript:void(0)" class="ufbl-field-settings-trigger button-primary"><?= _e( 'الإعدادات', 'ultimate-form-builder-lite' ); ?></a><span>+</span>
							...
							case 'captcha':
								...
								<div class="ufbl-each-form-field ufbl-submit-button-wrap ufbl-relative">
									<span class="ufbl-drag-arrow"><i class="fa fa-arrows"></i></span>
									<div class="ufbl-form-field-wrap">
										<label class="ufbl-field-label-ref"><?php echo (isset( $val['field_label'] ) && $val['field_label'] != '') ? esc_attr( $val['field_label'] ) : 'Captcha بدون عنوان'; ?></label>
										<div class="ufbl-form-field">
	...
	<div class="ufbl-form-controls ufbl-text-align-right">
		<input type="button" class="button-primary ufbl-save-form" value="<?php _e( 'حفظ النموذج', 'ultimate-form-builder-lite' ); ?>"/>
		<a href="<?php echo site_url( '?ufbl_form_preview=true&ufbl_form_id=' . $form_row['form_id'] ); ?>" target="_blank"><input type="button" class="button-primary" value="<?php _e( 'عرض', 'ultimate-form-builder-lite' ); ?>"/></a>
		<div class="ufbl-field-note"><?php _e( 'ملاحظة: يجب الحفظ قبل العرض.', 'ultimate-form-builder-lite' ); ?></div>
	</div>
	<div class="ufbl-clear"></div>
</div>
