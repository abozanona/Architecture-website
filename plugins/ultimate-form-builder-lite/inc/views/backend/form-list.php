...
<div class="wrap">
	...
	<div class="ufbl-form-list">
		<h2><?php _e( 'النماذج', 'ultimate-form-builder-lite' ); ?><a href="javascript:void(0);" class="ufbl-add-form-trigger add-new-h2"><?php _e( 'إضافة نموذج جديد' ); ?></a></h2>

		<table class="wp-list-table widefat fixed posts ufbl-table">
			<thead>
				<tr>
					<th scope="col" id="title" class="manage-column column-shortcode">
						<?php _e( 'عنوان النموذج', 'ultimate-form-builder-lite' ); ?>
					</th>
					<th scope="col" id="shortcode" class="manage-column column-shortcode">
						<?php _e( 'رمز النموذج', 'ultimate-form-builder-lite' ); ?>
					</th>
					<th scope="col" id="last-modified" class="manage-column column-shortcode">
						<?php _e( 'آخر تعديل', 'ultimate-form-builder-lite' ); ?>
					</th>
					<th scope="col" id="status" class="manage-column column-shortcode">
						<?php _e( 'الحالة', 'ultimate-form-builder-lite' ); ?>
					</th>
				</tr>
			</thead>
			<tfoot>
				<tr>
					<th scope="col" id="title" class="manage-column column-shortcode" >
						<span><?php _e( 'عنوان النموذج', 'ultimate-form-builder-lite' ); ?>
					</th>
					<th scope="col" id="shortcode" class="manage-column column-shortcode">
						<?php _e( 'رمز النموذج', 'ultimate-form-builder-lite' ); ?>
					</th>
						...
						<tr class="<?php if ( $form_counter % 2 != 0 ) { ?>alternate<?php } ?>">
							<td class="title column-title">
								...
								<div class="row-actions ufbl-relative">
									...
									<span class="ufbl-preview"><a href="<?php echo site_url( '?ufbl_form_preview=true&ufbl_form_id=' . $form->form_id ); ?>" target="_blank"><?php _e( 'عرض', 'ultimate-form-builder-lite' ); ?></a> | </span>
									<span class="ufbl-entries"><a href="<?php echo admin_url( 'admin.php?page=ufbl-form-entries&form_id=' . $form->form_id ); ?>"><?php _e( 'المدخلات', 'ultimate-form-builder-lite' ); ?></a></span>
									<div class="ufbl-delete-confirmation" style="display:none">
										<p><?php _e( 'هل أنت متأكد من أنك تريد حذف هذا النموذج?', 'ultimate-form-builder-lite' ); ?></p>
										<input type="button" value="<?php _e( 'نعم', 'ultimate-form-builder-lite' ); ?>"  data-form-id="<?php echo $form->form_id; ?>" class="ufbl-delete-yes ufbl-form-delete-yes"/>
										<input type="button" value="<?php _e( 'إلغاء الأمر', 'ultimate-form-builder-lite' ); ?>"  data-form-id="<?php echo $form->form_id; ?>" class="ufbl-delete-cancel ufbl-form-cancel"/>
...
<div class="ufbl-popup-wrap" style="display: none">
	...
	<div class="ufbl-add-form-wrap">
		...
		<div class="ufbl-add-field-wrap">
			<input type="button" class="ufbl-form-add-btn button-primary" value="<?php _e( 'إضافة النموذج', 'ultimate-form-builder-lite' ); ?>"/><span class="ufbl-ajax-loader" style="display: none"></span><span class="ufbl-msg" style="display:none;"><?php _e( 'Form Created.Redirecting...' ); ?></span>
...
<div class="ufbl-copy-popup-wrap" style="display: none">
	...
	<div class="ufbl-add-form-wrap">
		<div class="ufbl-add-field-wrap">
			<label><?php _e( 'نسخ عنوان النموذج', 'ultimate-form-builder-lite' ); ?></label>
			<div class="ufbl-field"><input type="text" class="ufbl-form-title" placeholder="<?php _e( 'اسم النموذج', 'ultimate-form-builder-lite' ); ?>"/></div>
			<div class="ufbl-field-note"><?php _e( 'يرجى إدخال عنوان النموذج', 'ultimate-form-builder-lite' ); ?></div>
		</div>
		<div class="ufbl-add-field-wrap">
			...
			<div class="ufbl-field-note"><?php _e( 'اختر نموذجاً لنسخه.', 'ultimate-form-builder-lite' ); ?></div>
		</div>
		<div class="ufbl-add-field-wrap">
			<input type="button" class="ufbl-form-copy-btn button-primary" value="<?php _e( 'نسخ النموذج', 'ultimate-form-builder-lite' ); ?>"/><span class="ufbl-ajax-loader" style="display: none"></span><span class="ufbl-msg" style="display:none;"><?php _e( 'Form Copied.Redirecting...' ); ?></span>
			<div class="ufbl-add-error ufbl-error" style="display: none;"></div>
		</div>
	</div>
</div>